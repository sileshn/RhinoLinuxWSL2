    ...
    select yn in "Yes" "No"; do
        case $yn in
            Yes)
                ...
                secs=3
                printf ${ylw}"\nPlease grant diskpart elevated permissions when requested. RhinoLinuxWSL2 will restart after disk resize.\n"${txtrst}
...
secs=3
printf ${ylw}"\nRhinoLinuxWSL2 will shutdown and restart to setup systemd!!!\n\n"${txtrst}
while [ $secs -gt 0 ]; do
    printf "\r\033[KShutting down in %.d seconds. " $((secs--))
    sleep 1
done
